...
- В папке "Cкриншоты" показано как работает приложение (если какие-то методы не добавил в скрины, пропустил случайно их), со всеми возможными исходами, включая то, как выглядит сваггер.
